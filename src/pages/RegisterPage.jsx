      ...
      <ScrollReveal className="w-full max-w-md">
        ...
        <div className="card-dark p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="bg-dark-600 hover:bg-dark-500 border border-dark-500 rounded-btn py-3 text-cream text-sm font-medium flex items-center justify-center gap-2 transition-all">
