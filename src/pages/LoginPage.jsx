...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (email === 'admin@ymy.com') navigate('/admin');
    else if (email === 'guide@ymy.com') navigate('/guide-dashboard');
      ...
      <ScrollReveal className="w-full max-w-md">
        ...
        <div className="card-dark p-8">
          ...
          <div className="space-y-3 mb-6">
            <button className="w-full bg-dark-600 hover:bg-dark-500 border border-dark-500 rounded-btn py-3 text-cream text-sm font-medium flex items-center justify-center gap-3 transition-all">
            ...
            <button className="w-full bg-[#1877F2] hover:bg-[#166FE5] rounded-btn py-3 text-white text-sm font-medium flex items-center justify-center gap-3 transition-all">
        ...
        <p className="text-center text-muted-dark text-xs mt-6">
          Demo: use <span className="text-gold">admin@ymy.com</span> for admin, <span className="text-gold">guide@ymy.com</span> for guide, or any email for tourist.
        </p>
      </ScrollReveal>
    </main>
  );
