    ...
    <main className="pt-24 min-h-screen bg-dark-900 flex items-center justify-center px-4 py-16">
      <ScrollReveal className="w-full max-w-3xl">
        <div className="text-center mb-10">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl font-bold text-cream mb-2">Welcome back</h1>
          <p className="text-muted text-sm">How would you like to continue?</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {/* Visitor */}
          <div className="card-dark p-8 flex flex-col items-center text-center border-gold/10 hover:border-gold/40 transition-all duration-300">
